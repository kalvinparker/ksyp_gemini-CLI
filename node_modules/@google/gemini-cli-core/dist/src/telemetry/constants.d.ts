...
export declare const EVENT_STARTUP_PERFORMANCE = "gemini_cli.startup.performance";
export declare const EVENT_MEMORY_USAGE = "gemini_cli.memory.usage";
export declare const EVENT_PERFORMANCE_BASELINE = "gemini_cli.performance.baseline";
export declare const EVENT_PERFORMANCE_REGRESSION = "gemini_cli.performance.regression";
